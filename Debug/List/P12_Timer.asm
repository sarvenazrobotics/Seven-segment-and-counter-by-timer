...
;
;void main(void)
; 0000 001D {   DDRB |= (1<<5);     // PB5 output (Segment B)

	.CSEG
_main:
; .FSTART _main
	SBI  0x4,5
; 0000 001E     DDRC |= 0x3F;       // PC0-PC5 output (Segments A,C,D,E,F,G)
	IN   R30,0x7
	ORI  R30,LOW(0x3F)
	OUT  0x7,R30
; 0000 001F     DDRD |= 0x1F;       // PD0-PD4 output (DP, DIG1-DIG4)
	IN   R30,0xA
	ORI  R30,LOW(0x1F)
	OUT  0xA,R30
; 0000 0020 
; 0000 0021     //initialize
; 0000 0022     counter=2000;
	LDI  R30,LOW(2000)
	LDI  R31,HIGH(2000)
	STS  _counter,R30
	STS  _counter+1,R31
; 0000 0023     //update_digits();
; 0000 0024 
; 0000 0025     //start timers
; 0000 0026     //timer_init();
; 0000 0027 
; 0000 0028 
; 0000 0029      //TIMER0-NORMAL MODE-PRESCALER=64-1.024ms overflow
; 0000 002A      TCCR0B=0x3;//division by 64 //TCCR0B=(1<<CS02)|(1<<CS00)
	LDI  R30,LOW(3)
	OUT  0x25,R30
; 0000 002B      TIMSK0=0x1;//overflow interrupt enable //(1<<TOIE0)
	LDI  R30,LOW(1)
	STS  110,R30
; 0000 002C      //TIMER2
; 0000 002D      TCCR2B=(1<<CS22);
	LDI  R30,LOW(4)
	STS  177,R30
; 0000 002E      TIMSK2=(1<<TOIE2);
	LDI  R30,LOW(1)
	STS  112,R30
; 0000 002F 
; 0000 0030 
...
; 0000 003D {
; 0000 003E     A(dat & 0x01);
;	dat -> Y+0
; 0000 003F     B(dat & 0x02);
; 0000 0040     C(dat & 0x04);
; 0000 0041     D(dat & 0x08);
; 0000 0042     E(dat & 0x10);
; 0000 0043     F(dat & 0x20);
; 0000 0044     G(dat & 0x40);
; 0000 0045     DP(dat & 0x80);
; 0000 0046 }
;
...
; 0000 004E   DIG4(0);
	SBI  0xB,4
; 0000 004F   switch(current_digit)
	LDS  R30,_current_digit
	LDI  R31,0
; 0000 0050   {
; 0000 0051     case 0:
	SBIW R30,0
